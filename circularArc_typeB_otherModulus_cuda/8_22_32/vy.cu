...
#define v1_x 0.5
#define v1_y 0.8660254037844386
#define v2_x -0.9659258262890682
#define v2_y 0.25881904510252074
#define v3_x -0.5
#define v3_y -0.8660254037844386
#define v4_x 1.0
#define v4_y 0.0
...
__device__ unsigned int walk_on_spheres_device(double x1, double y1,
    ...
    while (j < NN) {
        ...
        if ((wx >= 0.0 && (0.0 <= wy && wy <= wx * sqrt(3.0))) ||
            (wx < 0.0 && (tan(11.0 / 12.0 * PI) * wx > wy && wy > wx * sqrt(3.0)))) {
            distance = sqrt(fmin(
                (wx - 1.0) * (wx - 1.0) + wy * wy,
                fmin(
