// vy.cu
// CUDA version of vy.c (circular arc variant with center2x=0.0)
                                            ...
                                            curandStatePhilox4_32_10_t* rng)
{
    ...
    while (j < NN) {
        ...
        double d2 = length(wx - Tarc2Centerx, wy - Tarc2Centery) - Tarc2Radius;
        double d4 = length(wx - Tarc4Centerx, wy - Tarc4Centery) - Tarc4Radius;
        distance  = (d2 < d4) ? d2 : d4;

        double d_outer = 1.0 - length(wx, wy);
